...
% However, only anonymization---where re-identification is impossible---fully exempts data from the GDPRs scope, whereas pseudonymized data remain subject to its provisions. 
