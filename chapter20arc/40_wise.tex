...
\begin{table}[htbp]
  ...
  \begin{minipage}[t]{0.45\linewidth}
    ...
    \begin{tabularx}{\textwidth}{X|X|X|X|}
      \cline{2-4}
      & \centering{}\textbf{Prec} & \centering{}\textbf{Rec} & \centering{}\arraybackslash{}\textbf{F$_1$} \\
      \hline
