...
Recent approaches focus on efficient, end-to-end \ac{nel} systems that can recognize and link entities within a single forward pass~\cite{ayoola-etal-2022-refined,plekhanov2023multilingualendendentity}. 
