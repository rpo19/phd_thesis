...
\textcite{ijckg2022}---one of the contributions of this \phd, further detailed in \Cref{sec:ijckg}---introduced a benchmark dataset, an evaluation methodology, and a baseline pipeline for \acl{inel}. 
...
More recently, \ac{llm}-based models perform NIL prediction as multi-choice \ac{qa}, including ``none-of-the-candidates'' as an option~\cite{zhou-etal-2024-gendecider,ding-etal-2024-chatel}.
