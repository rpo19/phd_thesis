...
% These metadata might depend on the specific \ac{ima}, e.g., WhatsApp, but do not depend on the forensic application used for the dump extraction. However different forensic application would likely export data in different formats.
