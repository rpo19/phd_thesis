...
An additional contribution of my \phd is \emph{\mammotab}~\cite{mammotab}, a large-scale dataset of 1 million annotated Wikipedia tables extracted from 20 million pages and aligned with Wikidata. This contribution is not part of this thesis but still addresses a related topic, \acf{sti}---the task of identifying entities (similarly to \ac{ner} and \ac{nel} for text), columns types, and relations between columns in tabular data. Among the challenges addressed, \mammotab was also constructed for the \nilchallenge, thus this dataset include NIL-labeled instances.
