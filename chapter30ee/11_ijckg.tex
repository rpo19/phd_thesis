...
The NIL prediction component, despite its high precision, suffers from low recall, leading to a large number of false negatives---or \emph{false links}, that is, mentions incorrectly predicted as non-NIL and linked to the \ac{kr} while actually referring to new entities.
Errors from the NIL predictor introduce two critical issues in the pipeline.
First, each false positive---or \emph{false NIL}, i.e., a non-NIL mention incorrectly classified as NIL---creates a spurious entity.
