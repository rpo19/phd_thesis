\section{Previous Prototypes}
\label{sec:arch_proto}

The architectural model introduced in this chapter derives from the experience acquired in previous projects. In this section we compare it with previous prototypes developed as part of my \phd, namely \textcite{BELLANDI2024,pozzi_wise_2025,Agazzi2025DAVE}. Among these, only \textcite{BELLANDI2024} explicitly treated architecture as a research goal, but all these works implemented parts of the principles and functional requirements that are now formalized in this chapter.
...
\begin{table}[htbp]
\centering
\caption{Support of \ac{dia} requirements across prior works
