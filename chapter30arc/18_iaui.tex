...
Most of the \acp{ui} applied to in-domain work~\cite{BELLANDI2024,pozzi_wise_2025} have been later consolidated in \acf{dave}~\cite{Agazzi2025DAVE}.

\paragraph{Document Explorer.}
The \emph{document explorer}, introduced in \textcite{BELLANDI2024} and continued with \textcite{pozzi_wise_2025,Agazzi2025DAVE}, allows to visualize annotated documents, select annotation sets, inspect properties, and provides entity-based document navigation---\ie the user can expand a list of entities in the document, see a preview of all the mentions, and by clicking one mention the system brings the user to that exact fraction of the document.
These interfaces support \ref{uc:navigation} and \emph{traceability and verifiability} to a considerable extent, only lacking a global entity visualization, that is instad provided per-document.
