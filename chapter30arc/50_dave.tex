...
% that account for entity clustering in a direct (e.g., via coreference resolution~\cite{streaming_crossdoc_coreference}) or indirect (e.g., via entity linking~\cite{pozzi_wise_2025,kassner-etal-2022-edin}) way.      
