...
\begin{itemize}
	...
	\item I will present Ref.~\cite{Pozzi2025ReFactX} at the 24th international semantic web conference (ISWC 2025).
\end{itemize}
As an \textbf{author}:
\begin{itemize}
	...
	\item Ref.~\cite{Pozzi2025ReFactX} to appear in the Proceedings of the 24th international semantic web conference (ISWC 2025).
\end{itemize}
%%%%%%%
\tableofcontents
