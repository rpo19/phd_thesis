...
\begin{definition}
    [Language Model] A \acf{lm} is a probability distribution over a vocabulary of tokens, typically conditioned on an input sequence, and used to predict the next token~\cite{lm_java_methods_2023,jm3}.
\end{definition}
