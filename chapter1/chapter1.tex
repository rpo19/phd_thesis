...
The transformer architecture is composed of a stack of encoders and a stack of decoders, and it is cabable of modeling sequences of tokens relying on the \emph{attention mechanism}, supported by positional encodings that provide information about the order of the tokens order~\cite{vaswani_transformers_2017}.\todo{describe encoder decoder, attention and self attention}.
