...
Transformers have been introduced in 2017 by \textcite{vaswani_transformers_2017} and evaluated on the machine translation task, demonstrating superior performance and higher parallization at training-time compared to previous architectures~\cite{vaswani_transformers_2017}.
The transformer architecture is composed of a stack of encoders and a stack of decoders. A core component of transformers is the \emph{attention mechanism}\todo{describe encoder decoder, attention and self attention}.
\todo{briefly introduce representation learning, word embeddings and maybe knowledge grah embeddings}
