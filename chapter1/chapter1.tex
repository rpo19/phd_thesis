...
This section aims to describe to the reader the context necessary for the understanding of this \phd thesis, starting with a detailed description of the two knowledge-intensive domains considered by the presented work---in Section ~\ref{sec:domains}, followed by the description of state-of-the-art information extraction and access techniques---respectively explored in Sections~\ref{} and \ref{}.
...
\textbf{information extraction (IE)} ``refers to
