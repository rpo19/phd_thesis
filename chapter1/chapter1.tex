...
``An entity is an object or concept in the real world that can be distinctly
identified''~\cite{entityorientedsearch2018}.
\end{definition}
Examples of entities include ``John Smith'', ``Google Inc.'', ``Rome'', which respectively refer to a person, an organization, and a geopolitical entity. All of these correspond to \textit{named entities}. but also concepts...
