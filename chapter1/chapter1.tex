...
\todo{problem of incompleteness. to introduce the incremental kbp}
\Acl{kr} suffer from incompleteness, since there is always new information to add or update~\cite{entityorientedsearch2018}. \Acp{kb}, in particular, often require additional human effort with respect to unstructured \ac{kr}~\cite{}\todo{cite and give more focus to the incompleteness}.
