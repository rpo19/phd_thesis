...
One may wonder why \acp{kb} are still relevant in the era of \acp{llm}. Different studies have compared \aclp{llm} and \aclp{kb}~\cite{petroni-etal-2019-language-models-kbs,heinzerling-inui-2021-language} or \todo{kg roadmap. works that try to inject kb knowledge into llms,... or work that allow llms to query kbs? kb-rag? need also to detail rag}
