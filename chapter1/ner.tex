...
\end{definition}
While traditionally focused on entities like persons, organizations, and locations, \ac{ner} systems have been applied for recognizing wide range of entity types, such as dates, monetary values~\cite{muc6_overview_1995}, biomedical entities~\cite{}, legal references~\cite{}, and more~\cite{entityorientedsearch2018}. Furthemore, the interest in extending the types of entities recognized can be supported by the research on the field of fine-grained entity typing, which aims to classify entities into a larger set of more specific categories~\cite{}.
