...
\todo{zs gliner nuner trend, nested}


via prompting~\cite{liu2023pre}, achieving competitive performance in zero-shot and few-shot settings~\cite{keraghel2024recentadvancesnamedentity}.
\todo{gpt-ner, code llm, }

For further information refer to \textcite{keraghel2024recentadvancesnamedentity} for \ac{ner} and to \textcite{xu2024llm_for_ie} for \ac{ie} with \acp{llm}.
