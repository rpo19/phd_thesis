...
\caption{\ac{ner} backbones' pretraining domains (one model per column). Model names indicate the order in which the domain data were used for training.
...
\toprule
                              & \textbf{ITA} & \textbf{ITA+LGL+ICCJ900k}                                  & \textbf{ITA+LGL}                                      & \textbf{LGL+ICCJ900k}                                 & LGL                                     \\
                              \midrule
ITA & \ding{51}            & \ding{51}                                             & \ding{51}                                             & -                                        & -                                        \\
LGL            & -            & \ding{51}$^*$ & \ding{51}$^*$ & \ding{51}$^{**}$ & \ding{51}$^{**}$ \\
ICCJ900k                          & -            & \ding{51}                                             & -                                             & \ding{51}                                        & \ding{51}             \\
\bottomrule
\end{tabular*}
\end{table}