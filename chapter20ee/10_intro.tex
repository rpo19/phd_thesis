...
\begin{enumerate}
    \item introduction of the \acf{inel} task, with a methodology to adapt static \acf{nel} datasets and the release of a benchmark and baseline pipeline;
    \item evaluation of \acf{ner} and \acl{inel} on Italian civil judgments, including a study of domain adaptation strategies;
    \item creation of two annotated benchmarks for Italian civil judgments and investigative \acf{ima} data, and assessment of an \acl{ee} pipeline on both settings.
\end{enumerate}
