...
NIL clustering is also evaluated \textit{atomically} using MUC, B$_3$, and CEAF$_e$ as in \Cref{sec:inel_metrics}, reporting precision, recall, and F$_1$ for each. To avoid error propagation, clustering is run only on the NIL mentions from the ground truth.
