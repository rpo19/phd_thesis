...
Initially, \ac{er} annotations have been labeled on all the 146 documents by two annotators. Later, a subset of 30 documents has been additionally labeled for \ac{inel}. We will use ICCJ30-\ac{inel} to specifically refer to this subset.
...
For these reasons, we adopted the \ac{ner} F$_1$ score as the main metric is a more robust alternative to the classic metrics~\cite{hripcsak2005agreement, grouin2011proposal}.\todo{add evaluation metrics in rw??}
%, wang2021nero}.
