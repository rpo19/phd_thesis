...
Adapting and evaluating existing techniques for \acl{inel} is part of the \ref{ob:extraction_assessment}, which aims at assessing the feasibility of using existing approaches in the legal domain, for which the \nilchallenge is important.
...
\todo{modify how present my contribution}
