...
Evaluating an incremental pipeline is more complex than evaluating a single model, since errors propagate both through the pipeline and across time (\ie batches).
%
