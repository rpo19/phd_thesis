...
In this section, we address \ref{ob:extraction_assessment}, especially focusing on the \nilchallenge, by evaluating and adapting existing \ac{nel} techniques to \acf{inel}---which extends \acl{el} techniques to an incremental scenario where NIL mentions are identified, clustered, and finally added to the reference \ac{kr} (see \Cref{sec:incrementalel} for more).
