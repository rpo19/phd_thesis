...
The subsequent evaluations repeat the experiments done in \Cref{sec:judgment_ee_eval} but using the best in-domain fine-tuned \ac{ner} approach. 
...
\begin{itemize}
    ...
    \item precision, recall, and F$_1$ of the NIL prediction,\todo{specify for both the classes? also above}
...
\subsection{Adaptation Results and Discussion}
...
\paragraph{\ac{nel} and NIL Prediction}
