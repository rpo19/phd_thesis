...
To address RQ1, inspired by~\cite{pozzi2022,Heist2023nastylinker,kassner-etal-2022-edin} we develop a pipeline system that orchestrates first the entity extraction process, i.e., the NER task, and then the knowledge consolidation processes, namely NEL, NIL prediction, and NIL clustering.
...
% The NIL prediction and NIL clustering approaches are based on incremental extraction methods from English documents~\cite{pozzi2022}.
