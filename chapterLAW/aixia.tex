...
We use the library SpaCy-transformers\footnote{https://spacy.io/universe/project/spacy-transformers} with the SpaCy transition-based parser to leverage contextualized token representations obtained from a transformer~\cite{vaswani_transformers_2017}.
...
\subsubsection{NEL}
We evaluate the NEL component in terms of \textit{accuracy} and \textit{recall@100}, similarly to recent work~\cite{blink}, on the ICCJ test set, additionally comparing to the news-based benchmark VoxEL~\cite{rosales2018voxel}.
